...
class PixtralModel(VLModel):
    ...
    def collate_inner(self, vl_inputs: list[PixtralInput]) -> PixtralInput:
        assert len(vl_inputs) == 1
        return vl_inputs[0]

    def forward(self, vl_input: PixtralInput) -> Any:
        return self.model(
    ...
    def generate_inner(self, vl_input: PixtralInput) -> str:
